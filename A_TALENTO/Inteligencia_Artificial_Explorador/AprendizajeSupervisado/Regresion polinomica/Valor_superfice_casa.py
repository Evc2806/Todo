...
y_pred = modelo_red_neuronal.predict(superficie)  # Predicciones para los datos de entrenamiento
mse = mean_squared_error(costo, y_pred)  # Error cuadrático medio
r2 = r2_score(costo, y_pred)  # Coeficiente de determinación (R²)
